				...
				<div className="mt-16 grid gap-8 sm:grid-cols-2">
					...
					>
						...
						<p className="mt-3 text-sm leading-relaxed text-muted-foreground">
							Copy-paste the TAP prompt into your AI agent and let
							it handle registration, connection, and messaging
							automatically.
						</p>
					...
					>
						...
						<p className="mt-3 text-sm leading-relaxed text-muted-foreground">
							Install the CLI and run through identity
							registration, invites, and connections step by step.
						</p>

						<div className="mt-4 space-y-2 rounded-lg bg-zinc-950 p-4">
							{CLI_COMMANDS.map((cmd) => (
								<div key={cmd} className="flex items-start gap-2">
									<span className="select-none font-mono text-xs text-accent/50">
										$
									</span>
